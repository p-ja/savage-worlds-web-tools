availableLanguages.push ({
	...
	translations: {
			...
			BUTTON_LANG_BR: 'brazylijski',
			BUTTON_LANG_RU: 'rosyjski',
			...
			CHARGEN_CHARACTER_INFORMATION: 'Informacje o postaci',
			...
			CHARGEN_WEAPONS: 'Broñ',
			CHARGEN_HAND_WEAPONS: 'Broñ rêczna',
			CHARGEN_RANGED_WEAPONS: 'Ranged Weapons',
			CHARGEN_ARMOR: 'Pancerz',
			CHARGEN_SHIELDS: 'Tarcze',
